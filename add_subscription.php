...
if ($id_abo > 0) {
    echo '<h1>Add Subscription |<a href="javascript:self.history.back();"> Go Back</a></h1>';
    echo "<h1 style='color: red'>This member has already a subscription !</h1>";
}
else {
...
<body>
<h1 class="H1Name">Add Subscription |<a href="javascript:self.history.back();" class="aName"> Go Back</a></h1>
    ...
    <form action="add_subscription.php" method="get" name="form1">
    <table>
        <tr>
            <td class="titre">Subscription ID</td>
            <td class="titre"><input type="text" name="subscription_id" value="<?php echo $id_abo;?>"><small>(0 = ∅, 1 = VIP, 2 = GOLD, 3 = Classic, 4 = pass day)</small></td>
